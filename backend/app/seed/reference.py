...
CITY_SEEDS = [
    {'slug': 'ahmedabad', 'name': 'Ahmedabad', 'country': 'India', 'region': 'Gujarat', 'latitude': Decimal('23.022505'), 'longitude': Decimal('72.571362'), 'popularity_score': 74, 'cost_index': 'medium', 'image_url': 'https://images.unsplash.com/photo-1599831104321-71bc56950293?auto=format&fit=crop&w=1200&q=80', 'image_alt': 'Adalaj Stepwell, Ahmedabad'},
    {'slug': 'mumbai', 'name': 'Mumbai', 'country': 'India', 'region': 'Maharashtra', 'latitude': Decimal('19.075984'), 'longitude': Decimal('72.877656'), 'popularity_score': 91, 'cost_index': 'high', 'image_url': 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?auto=format&fit=crop&w=1200&q=80', 'image_alt': 'Gateway of India, Mumbai'},
    {'slug': 'goa', 'name': 'Goa', 'country': 'India', 'region': 'Konkan Coast', 'latitude': Decimal('15.299326'), 'longitude': Decimal('74.124008'), 'popularity_score': 96, 'cost_index': 'medium', 'image_url': 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=1200&q=80', 'image_alt': 'Palolem Beach, Goa'},
    {'slug': 'delhi', 'name': 'Delhi', 'country': 'India', 'region': 'Delhi NCR', 'latitude': Decimal('28.613939'), 'longitude': Decimal('77.209023'), 'popularity_score': 88, 'cost_index': 'medium', 'image_url': 'https://images.unsplash.com/photo-1587474260584-136574528ed5?auto=format&fit=crop&w=1200&q=80', 'image_alt': 'India Gate, Delhi'},
    {'slug': 'jaipur', 'name': 'Jaipur', 'country': 'India', 'region': 'Rajasthan', 'latitude': Decimal('26.912434'), 'longitude': Decimal('75.787270'), 'popularity_score': 93, 'cost_index': 'medium', 'image_url': 'https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=1200&q=80', 'image_alt': 'Hawa Mahal, Jaipur'},
    {'slug': 'udaipur', 'name': 'Udaipur', 'country': 'India', 'region': 'Rajasthan', 'latitude': Decimal('24.585445'), 'longitude': Decimal('73.712479'), 'popularity_score': 87, 'cost_index': 'medium', 'image_url': 'https://images.unsplash.com/photo-1615836245337-f5b9b2303f10?auto=format&fit=crop&w=1200&q=80', 'image_alt': 'City Palace on Lake Pichola, Udaipur'},
    {'slug': 'bengaluru', 'name': 'Bengaluru', 'country': 'India', 'region': 'Karnataka', 'latitude': Decimal('12.971599'), 'longitude': Decimal('77.594566'), 'popularity_score': 82, 'cost_index': 'medium', 'image_url': 'https://images.unsplash.com/photo-1596176530529-78163a4f7af2?auto=format&fit=crop&w=1200&q=80', 'image_alt': 'Cubbon Park, Bengaluru'},
    {'slug': 'manali', 'name': 'Manali', 'country': 'India', 'region': 'Himachal Pradesh', 'latitude': Decimal('32.239632'), 'longitude': Decimal('77.188713'), 'popularity_score': 89, 'cost_index': 'low', 'image_url': 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?auto=format&fit=crop&w=1200&q=80', 'image_alt': 'Solang Valley, Manali'},
]
