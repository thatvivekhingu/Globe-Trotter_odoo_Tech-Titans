import { BarChart3, Bell, Building2, CheckSquare, Compass, CreditCard, Globe, LayoutDashboard, Map, Menu, Plane, Plus, Search, Settings, Shield, Sparkles, UserCircle, WalletCards } from 'lucide-react'
